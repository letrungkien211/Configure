...
### Emacs
sudo apt-get install -y emacs24 gtk2-engines-pixbuf
sudo apt-get install -y emacs23 gtk2-engines-pixbuf
### OpenGL
...
### Jogl
#sudo apt-get install -y libjogl* 
### Python
...
/usr/share/doc/libdvdread4/install-css.shx
